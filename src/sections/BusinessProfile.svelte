...
<div class="my-4 border md:rounded md:border-blue-300">
    ...
    <div class="text-xs p-2 md:text-sm md:px-6 lg:px-8 lg:text-base lg:grid lg:grid-cols-3 lg:gap-y-2">
        ...
        <div class="p-2 font-medium lg:col-span-1">Nama Usaha<span class="text-red-500 text-xs font-light">*</span></div>
        ...
        <div class="p-2 font-medium lg:col-span-1">Bidang Usaha<span class="text-red-500 text-xs font-light">*</span></div>
        ...
        <div class="p-2 font-medium lg:col-span-1">Tahun Berdiri<span class="text-red-500 text-xs font-light">*</span></div>
        ...
        <div class="p-2 font-medium lg:col-span-1">Jumlah Pegawai Tetap<span class="text-red-500 text-xs font-light">*</span> <span class="text-xs font-light">(minimal 1 tahun kerja)</span></div>
        ...
        <div class="p-2 font-medium lg:col-span-1">Omset Usaha per Tahun<span class="text-red-500 text-xs font-light">*</span></div>
        ...
        <div class="p-2 font-medium lg:col-span-1">Sumber Pendanaan Modal Awal<span class="text-red-500 text-xs font-light">*</span></div>
        ...
        <div class="p-2 font-medium lg:col-span-3 lg:">Penjelasan Singkat Usaha<span class="text-red-500 text-xs font-light">*</span></div>
        ...
        <div class="p-2 font-medium lg:col-span-3">Ekspektasi Terhadap Usaha Anda Setelah Menjalani Program BCIC<span class="text-red-500 text-xs font-light">*</span></div>
        ...
        <div class="p-2 font-medium lg:col-span-3">Gambar Contoh Produk Anda<span class="text-red-500 text-xs font-light">*</span></div>
